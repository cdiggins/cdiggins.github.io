// Exports a function for generating a blog 
'use strict';

const fs = require("fs");
const path = require('path');
const mdToHtml = require('myna-parser/tools/myna_markdown_to_html');
const expand = require('myna-parser/tools/myna_mustache_expander');
...
// A data source has to provide us with basic folders
// The rest of the data source has to provide data to the template files. 
...
function generateBlog(dataSrc) 
{
    var data = { ...defaultDataSrc, ...dataSrc };    
